											...
											<tr>
												...
												<td align="center">
													<button type="button" class="btn btn-soft-info width-xs"
														onclick="window.open('/myPage/resume/detail?resumeId=${resumeList.resumeId}')">보기</button>
												</td>
												<td align="center">
													<button type="button" class="btn btn-soft-info width-xs"
							...
							<tbody id="tbody">
								<c:forEach items="${coverletterList}" var="coverletterList">
									<tr>
										...
										<fmt:parseDate value="${coverletterList.covltrInsertDate }" pattern="yyyy-MM-dd" var="starte"/> 
										<fmt:formatDate value="${starte }" pattern="yyyy-MM-dd" var="startee"/>
										<td align="center"><c:out value="${startee }" /></td>
										<td align="center">
											<button type="button" class="btn btn-soft-info width-xs"
