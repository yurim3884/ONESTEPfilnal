					...
					<div class="carousel-inner">
						<c:forEach items="${advertList }" var="advertList">
							...
							<c:if test="${advertList.advertId == 3 }">
								<div class="carousel-item">
									<img class="d-block w-100"
										src="/upload/${advertList.advertAtt }" onerror="this.src='${pageContext.request.contextPath }/resources/assets/img/1001.png'"
										width="728px" height="90px" style="border-radius: 5px;">
								</div>
							</c:if>
							...
							$.ajax({
										...
										success : function(res) {
											...
											for (var i = 0; i < res.annoList.length; i++) {
												...
												html += "                        <span class='strong' style='color: #db1414; '>마감일</span><span id='date' class='strong' style='color: #db1414;'>"
														+ res.annoList[i].strDate
														+ "</span>";
												html += "                    </div>";
												html += "                </div>";
												html += "            </div>";
