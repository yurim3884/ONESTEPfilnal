...
<body class="sigup-one" onload="Captcha();">
                ...
                <div class="col-xl-5 col-lg-6 col-md-6 col-sm-12 p-0">
                    <div class="login-one-start">
                        ...
                        <div class="row">
	                        ...
	                        <div class="col-1">
                            	<button type="button" class="btn-sm btn-success font-20"  onclick="fillCmpInfo()"><i class="las la-check-double"></i></button>
							</div>
						</div> 
                        ...
                        <div class="login-one-inputs mt-1">
                            <input type="text" id="companyNum" placeholder="사업자등록번호를 입력하세요" name="companyNum"/>
                        ...
                        <div class="login-one-inputs mt-1">
                            <input type="text" name="memTel" id="memTel1" style="width: 30%"  />- 
                            <input type="text" name="memTel" id="memTel2" style="width: 30%"  />-
                            <input type="text" name="memTel" id="memTel3" style="width: 30%" />
    ...
    function fillCmpInfo() {
    	$('input[name=companyNum]').val("3068205291");
    	$('input[name=memId]').val("dditkdd");
    	$('input[name=memPw]').val("dditkdd123");
    	$('input[name=memName]').val("김대덕");
    	$('input[name=memNick]').val("대덕킴");
    	$('input[id=memTel1]').val("010");
    	$('input[id=memTel2]').val("4229");
    	$('input[id=memTel3]').val("5222");
    	$('input[name=memZip]').val("34908");
    	$('input[name=memAddr2]').val("846");
    	$('input[name=memBirth]').val("1980-01-01");
//     	$('input[name=memEmail]').val("daedeok@ddit.or.kr");
