			...
			<li>
				<div class="page-header">
					<nav class="breadcrumb-one" aria-label="breadcrumb">
						<ol class="breadcrumb">
							<h4  id="item-1"></h4>
							<li class="breadcrumb-item active" aria-current="page"><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${covltr.covltrTitle } </span></li>
						</ol>
					</nav>
				</div>
			</li>
...
<!-- 		                       </div> -->
			                   ...
			                   <div class="button-list" style="position:sticky; top:777px;"></br>
			                   		<c:if test="${sessionScope.memberVO.memId eq member.memId}">
				                       <button type="button" id="btnList" class="btn btn-outline-primary" style="width:100%;">자기소개서 목록</button><br><br>
				                       <button type="button" id="btnDelete" class="btn btn-outline-danger" style="width:100%;">자기소개서 삭제</button><br><br>
				                       <button type="button" id="btnModify" class="btn btn-primary" style="width:100%;">자기소개서 수정</button><br>
			                  		</c:if>
			                   </div>
			               </div>
		                   <!-- ONGOING TASK ENDS-->
