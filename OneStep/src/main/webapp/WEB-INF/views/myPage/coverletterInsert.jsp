                        ...
                        <div class="col-lg-9 layout-spacing" id="covltrDiv">
                            ...
                            <div class="statbox widget box box-shadow">
	                            <div class="row">
									...
									<div class="col-1">
                                       	<button type="button" class="btn-sm btn-success font-20"  onclick="fillCovltr()"><i class="las la-check-double"></i></button>
									</div>                                       	
                               	</div>
							</div>	                        
...
function fillCovltr() {
	$('input[name=covltrTitle]').val('꾸준히 발전하는 신입 개발자가 되겠습니다.');
	$('input[name=covltrItemList\\[1\\]\\.covltrItemTitle]').val('가장 자랑스럽게 생각하는 성취의 경험');
	$('textarea[name=covltrItemList\\[1\\]\\.covltrItemContent]').val('“고객의 입장에서 생각하여 실패를 극복하다”<br>프랜차이즈 뷔페 매장에서 근무를 하며 고객만족도 설문조사 이벤트를 진행하던 중 낮은 응답률을 높이기 위해 최선을 한 경험이 있습니다. 긴장한 모습으로 고객들에게 다가간 첫날 등록된 설문조사는 1건에 불과했고 이후 며칠간 설문조사 응답률은 나아지지 않았습니다. 이러한 상황에서 응답률이 낮은 이유에 대해 고객의 시각에서 문제를 보았고 고객들은 설문조사에 응하는 시간을 아까워하고 절차에 대해 번거롭다는 인식을 가지고 있는 것이라고 분석했습니다. 첫 번째, 선채로 고객들에게 설명했던 전과 달리 고객들의 눈높이를 맞추기 위해 앉아서 설명했고 두 번째, 중년층 고객의 경우 모바일로 하는 설문조사 참여방법이 어려울 것이라 생각해 원하시는지 여쭤보고 직접 사이트에 접속해 드렸습니다. 마지막으로 설문조사에 소요되는 시간이 짧다는 것을 강조했습니다.<br>그 결과 첫 목표로 잡았던 10건 이상의 성과를 달성할 수 있었고 꾸준히 유지할 수 있었습니다.');
}
