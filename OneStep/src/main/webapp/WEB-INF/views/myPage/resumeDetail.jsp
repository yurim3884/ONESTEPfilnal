                        ...
                        <div class="col-lg-9 layout-spacing">
									...
									<div class="tab-pane fade show active" id="underline-specification" role="tabpanel" aria-labelledby="underline-specification-tab">
										<c:forEach items="${resume.eduList }" var="eduList">
	                                   		<div class="d-flex flex-wrap p-2">
	                                    		<p class="strong mb-4" id="subTitle">${eduList.eduSchoolName } ${eduList.eduMajor1 }</p>
	                                			<div class="row mb-3 w-100">
		                                        	<div class="col-md-4">
		                                            	<div>
		                                               		<p class="text-muted">• 구분:
		                                        	...
		                                        	<div class="col-md-4">
		                                            	<div>
		                                               		<p class="text-muted">• 입학: ${eduList.eduStart } </p>
		                                            	</div>
		                                        		<c:if test="${eduList.eduScoreStandard != null }">
		                                            	<div>
		                                               		<p class="text-muted">• 학점: ${resume.eduList[0].eduScore } / 
		                              				...
		                              				<div class="col-md-4">
		                                      			<div>
		                                               		<p class="text-muted">• 졸업: ${eduList.eduEnd } </p>
		                                   				</div>
		                                      		</div>
		                      					</div>
                      						</div>         
	                    	...
	                    	<div class="w-100 animated-underline-content mt-2 details-tab-area">
	                           ...
	                           <div class="tab-content" id="lineTabContent-3">
	                               <div class="tab-pane fade show active" id="underline-specification" role="tabpanel" aria-labelledby="underline-specification-tab">
	                                   <div class="d-flex flex-wrap p-2">
	                                       <p class="text-muted">• ${resume.workfieldList[0].workfield1 }	</p>
<%-- 	                                       <p class="text-muted">• ${resume.workfieldList[1].workfield1 } </p> --%>
	                                   </div>         
	                               </div>
		           				</div>
		           			</div>	
...
<%-- 												<p class="text-muted mb-5">• ${skill.skillName} &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p> --%>
<%-- 	                                   		</c:forEach> --%>
	                                   		
                             				<button type="button" class="btn btn-outline-primary btn-rounded "> ${resume.skillList[0].skillName }</button>
											<button type="button" class="btn btn-outline-success btn-rounded  "> ${resume.skillList[1].skillName }</button>
											<button type="button" class="btn btn-outline-info btn-rounded  ">	${resume.skillList[2].skillName }</button>
											<button type="button" class="btn btn-outline-warning btn-rounded  "> ${resume.skillList[3].skillName }</button>
											<button type="button" class="btn btn-outline-danger btn-rounded  "> ${resume.skillList[4].skillName }</button>
											<button type="button" class="btn btn-outline-dark btn-rounded  "> ${resume.skillList[5].skillName }</button>
											<button type="button" class="btn btn-outline-secondary btn-rounded "> ${resume.skillList[6].skillName }</button>
	                    	...
	                    	<div class="w-100 animated-underline-content mt-2 details-tab-area">
	                        	<ul class="nav nav-tabs  mb-3" id="lineTab" role="tablist">
	                  			...
	                  			<div class="tab-content" id="lineTabContent-3">
									<div class="tab-pane fade show active" id="underline-specification" role="tabpanel" aria-labelledby="underline-specification-tab">
									    <div class="d-flex flex-wrap p-2">
									        <p class="strong mb-4" id="subTitle">	${resume.careerList[0].careerCmpName } (<c:if test="${resume.careerList[0].careerResignDate == null}" >${resume.careerList[0].careerJoinDate}" ~ 재직 중</c:if>
...
<!-- 	                                   				</p> -->
													<div>
													    <p class="text-muted">•  부서:	${resume.careerList[0].careerCmpDprtm }</p>
														<p class="text-muted">•  연봉:	${resume.careerList[0].careerSalary }만 원</p>
													</div>
	                                         	</div>
	                                        	<div class="col-md-4">
                                            		<div>
	                                       				<p class="text-muted">•  직급:	${resume.careerList[0].careerPosition }</p>
	                                           		</div>
	                                 			</div>
	                                        	<div class="col-md-4">
	                                          		<div>
	                                                	<p class="text-muted">•  담당 직무:		${resume.careerList[0].careerWorkfield }</p>
                                         			</div>
	                                        	</div>
	                                		</div>
	                                		<div class="row">
	                                			<div class="col-12">
		                                        	...
		                                        	<p class="text-muted">•  업무 상세:		${resume.careerList[0].careerDuties }</p>
	                                			</div>
	                                		</div>
	                            		</div>         
	                            	</div>
	                     		...
	                     		<div class="tab-content" id="lineTabContent-3">
	                          		<div class="tab-pane fade show active" id="underline-specification" role="tabpanel" aria-labelledby="underline-specification-tab">
	                                	<div class="d-flex flex-wrap p-2">
	                                   		<div class="row mb-3 w-100">
	                                        	<div class="col-md-4">
	                                            	<p class="strong mb-4" id="subTitle">${resume.certList[0].certName }</p>
	                                              	<div>
	                                                	<p class="text-muted">•  ${resume.certList[0].certDate }</p>
	                                                	<p class="text-muted">•  ${resume.certList[0].certInstitution }</p>
	                                            	</div>
	                                       		</div>
	                                       		<div class="col-md-4">
	                                      			<p class="strong mb-4" id="subTitle">${resume.certList[1].certName }</p>
	                                        		<div>
	                                                 	<p class="text-muted">• ${resume.certList[1].certDate }</p>
	                                                	<p class="text-muted">•  ${resume.certList[1].certInstitution }</p>
	                                             	</div>
	                                        	</div>
	                                      		<div class="col-md-4">
	                                              	<p class="strong mb-4" id="subTitle">${resume.certList[2].certName }</p>
	                                              	<div>
	                                                	<p class="text-muted">• ${resume.certList[1].certDate }</p>
	                                                	<p class="text-muted">•  ${resume.certList[2].certInstitution }</p>
	                                              	</div>
	                                         	</div>
	                                		</div>
	                                 	</div>         
...
<!-- 	                                     	</p> -->
	                                		<div class="row mb-3 w-100">
	                                       		<div class="col-md-4">
	                                           		<p class="strong mb-4" id="subTitle">${resume.langList[0].langTestName }</p>
	                                        		<div>
	                                                	<p class="text-muted">•  ${resume.langList[0].langTestDate } </p>
	                                               	<p class="text-muted">•  ${resume.langList[0].langTestScore }점</p>
	                                           		</div>
	                                    		</div>
	                                        	<div class="col-md-4">
	                                            	<p class="strong mb-4" id="subTitle">${resume.langList[1].langTestName }</p>
	                                           		<div>
														<p class="text-muted">•  ${resume.langList[1].langTestDate } </p>
														<p class="text-muted">•  ${resume.langList[1].langTestScore }점</p>
													</div>
	                                 			</div>    
	                                       		<div class="col-md-4">
	                                            	<p class="strong mb-4" id="subTitle">${resume.langList[2].langTestName }</p>
	                                            	<div>
	                                                	<p class="text-muted">•  ${resume.langList[2].langTestDate }</p>
	                                                	<p class="text-muted">•  ${resume.langList[2].langTestScore }점</p>
	                                          		</div>
	                                       		</div>
	                                    	</div>
	                                 	</div>
                    		...
                    		<c:forEach items="${resume.activityList}" var="activity">
									    <div class="d-flex flex-wrap p-2">
									        <p class="strong mb-4" id="subTitle">${activity.actInstitution }</p>
									        <div class="row mb-3 w-100">
									            <div class="col-md-5">
													<div>
													    <p class="text-muted">• 활동구분: 
													    	<c:if test="${activity.actCategory == 1}">인턴&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</c:if>
															<c:if test="${activity.actCategory == 2}">아르바이트&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</c:if>
															<c:if test="${activity.actCategory == 3}">동아리&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</c:if>
															<c:if test="${activity.actCategory == 4}">자원봉사&nbsp&nbsp&nbsp&nbsp</c:if>
															<c:if test="${activity.actCategory == 5}">사회활동&nbsp&nbsp&nbsp&nbsp</c:if>
															<c:if test="${activity.actCategory == 6}">교내활동&nbsp&nbsp&nbsp&nbsp</c:if>
													    </p>
													</div>
	                                         	</div>
	                                        	<div class="col-md">
                                            		<div>
                                       				  	<p class="text-muted">•  ${activity.actStart } ~ ${activity.actEnd } </p>
	                                           		</div>
	                                 			</div>
	                                		</div>
	                                		<div class="row mb-3 w-100">
	                                			<div class="col">
	                                          		<div>
	                                                	<p class="text-muted">•  ${activity.actContent }</p>
                                         			</div>
	                                        	</div>
	                                		</div>
	                            		</div>         
								    ...
								    <div class="tab-pane fade show active" id="underline-specification" role="tabpanel" aria-labelledby="underline-specification-tab">
								        <div class="d-flex flex-wrap p-2">
								            <div class="row mb-3 w-100">
								                <div class="col-md-8">
								                    <div>
								                        <p class="text-muted">•  URL	│	<a href="${resume.portfolioList[0].portfolioUrl }">${resume.portfolioList[0].portfolioUrl }</a></p>
<!-- 								                        <p class="text-muted">•  첨부파일	│	</p> -->
<!-- 								                        <div class="file doc"> -->
								            ...
								            <div class="row mb-3 w-100">
								                <div class="col-md-8">
								                    <div>
								                        ...
								                        <p class="text-muted">•		희망근무지	│	${resume.desiredList[0].desiredCity1 }&nbsp;&nbsp;${resume.desiredList[0].desiredCity2 }&nbsp;</p>
								                        <p class="text-muted">•		희망연봉		│	${resume.desiredList[0].desiredSalary }만 원</p>
								                        <p class="text-muted">•	 	지원 분야		│	${resume.desiredList[0].desiredIndustry1 }&nbsp;&nbsp;${resume.desiredList[0].desiredIndustry2 }&nbsp;&nbsp;${resume.desiredList[0].desiredIndustry3}</p>
								                    </div>
								                </div>
                        ...
                        <div class="col-lg-3 layout-spacing" id="scroll">
		                    ...
		                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing" style="position:sticky; top:77px;" >
			                   ...
			                   <div class="button-list">
				                       ...
				                       <button type="button" id="btnDelete" class="btn btn-outline-danger" style="width:100%;">이력서 삭제</button><br>
