                    	...
                    	<div class="col-lg-9 layout-spacing">
	                    	<div class="statbox widget box box-shadow">
	                        	<div class="widget-header">
	                            	<div class="row">
                                        <div class="col">
	                                    	<h4>이력서 제목<span class="text-danger">*</span></h4>
										</div>
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillTitle()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
	                        	</div>
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">
                                    <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillEdu()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
                                </div>
...
<%-- 											  <option value="3" ${select3} >대학교(4년)</option> --%>
							...
							<div class="statbox widget box box-shadow" id="skillForm" >
								...
								<div class="widget-content widget-content-area">
									...
									<div id="skillList">
										<button type="button" class="btn btn-outline-primary btn-rounded "><i class="fas fa-plus fa-xs"></i> SVN</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-success btn-rounded  "><i class="fas fa-plus fa-xs"></i> OracleDB</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-info btn-rounded  "><i class="fas fa-plus fa-xs"></i>	RestAPI</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-warning btn-rounded  "><i class="fas fa-plus fa-xs"></i> Spring</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-danger btn-rounded  "><i class="fas fa-plus fa-xs"></i> Java</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-dark btn-rounded  "><i class="fas fa-plus fa-xs"></i> Jquery</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-secondary btn-rounded "><i class="fas fa-plus fa-xs"></i> Kafka</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-primary btn-rounded  "><i class="fas fa-plus fa-xs"></i> Hadoop</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-success btn-rounded  "><i class="fas fa-plus fa-xs"></i> ASP.NET MVC</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-info btn-rounded  "><i class="fas fa-plus fa-xs"></i> GraphQL</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-warning btn-rounded  "><i class="fas fa-plus fa-xs"></i> Webpack</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-danger btn-rounded  "><i class="fas fa-plus fa-xs"></i> Jira</button>&nbsp&nbsp&nbsp
										<button type="button" class="btn btn-outline-dark btn-rounded  "><i class="fas fa-plus fa-xs"></i> TypeScript</button>&nbsp&nbsp&nbsp
							...
							<div class="statbox widget box box-shadow">
		                        <div class="widget-header">
		                            <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillWorkfield()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
		                        </div>
								<div class="widget-content widget-content-area">
							...
							<div class="statbox widget box box-shadow">
							    <div class="widget-header">
							        <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillDesired()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
							    </div>
								<div class="widget-content widget-content-area">
							...
							<div class="statbox widget box box-shadow" id="languageForm" style="display:none">
								<div class="widget-header">
	                            	<div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillLanguage()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
								</div>
							...
							<div class="statbox widget box box-shadow" id="certificationForm" style="display:none">
							    <div class="widget-header">
							        <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillCertification()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
	       						</div>
							...
							<div class="statbox widget box box-shadow" id="awardForm" style="display:none">
							    <div class="widget-header">
							        <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillAward()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
							    </div>
								<div class="widget-content widget-content-area" id="award">
								 	<div class="form-group row">
										<div class="col-lg-4">
									 	...
									 	<div class="col-lg-4">
								  			<label>수여기관:</label>
											<input name="awardList[0].awardInstitution" value="${resume.awardList[0].awardInstitution }" type="text" class="form-control">
										</div>
					 					<div class="col-lg-3">
									  		<label>수상연도:</label>
	                        ...
	                        <div class="statbox widget box box-shadow" id="activityForm" style="display:none">
	                        	<div class="widget-header">
	                            	<div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillAct()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
	                           	</div>
							...
							<div class="statbox widget box box-shadow" id="careerForm" style="display:none">
								<div class="widget-header">
								    <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillCareer()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
				                </div>
								<div class="widget-content widget-content-area" id="career">
	                  		    	<div class="form-group row">
						    			...
						    			<div class="col-lg-2">
							    			<label>입사년월:</label>
											<input name="careerList[0].careerJoinDate" value="${resume.careerList[0].careerJoinDate }" type="text" class="form-control" placeholder="20210101">
										</div>
						    			<div class="col-lg-2">
							    			<label>퇴사년월:</label>
											<input name="careerList[0].careerResignDate" value="${resume.careerList[0].careerResignDate }" type="text" class="form-control" placeholder="20230131">
										</div>
										<div class="col-lg-1">
									...
									<div class="form-group row">										
										...
										<div class="col-lg-3">
											<label>연봉:</label>
											<input name="careerList[0].careerSalary" value="${resume.careerList[0].careerSalary }" type="text" class="form-control" placeholder="ex) 4,0000">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-lg-12">
							...
							<div class="statbox widget box box-shadow" id="prfrnForm" style="display:none">
	                        	<div class="widget-header">
	                            	<div class="row">
										...
										<div class="col-1">
	                                      	<button type="button" class="btn-sm btn-success font-20"  onclick="fillPrfrn()"><i class="las la-check-double"></i></button>
										</div>                                       	
	                            	</div>
								</div>
								<div class="widget-content widget-content-area">
							...
							<div class="statbox widget box box-shadow" id="portfolioForm" style="display:none">
								<div class="widget-header">
								    <div class="row">
										...
										<div class="col-1">
                                        	<button type="button" class="btn-sm btn-success font-20"  onclick="fillPortfolio()"><i class="las la-check-double"></i></button>
										</div>                                       	
                                	</div>
								</div>
								<div class="widget-content widget-content-area">
...
function fillTitle() {
	$('input[name=resumeTitle]').attr('value', "끊임없이 공부하는 개발자가 되겠습니다.");
}


function fillEdu() {
	$('select[name=eduList\\[0\\]\\.eduSchoolType]').val('3');
	$('input[name=eduList\\[0\\]\\.eduSchoolName]').attr('value', "충남대학교");
	$('input[name=eduList\\[0\\]\\.eduStart]').attr('value', '2009-03-02');
	$('input[name=eduList\\[0\\]\\.eduEnd]').attr('value', '2014-08-25');
	$('input[name=eduList\\[0\\]\\.eduMajor1]').attr('value', '컴퓨터공학과');
	$('input[name=eduList\\[0\\]\\.eduScore]').attr('value', '4.2');
	$('select[name=eduList\\[0\\]\\.eduScoreStandard]').val('1');
	$('select[name=eduList\\[0\\]\\.eduStatus]').val('1');
	
	$('select[name=eduList\\[1\\]\\.eduSchoolType]').val('1');
	$('input[name=eduList\\[1\\]\\.eduSchoolName]').val("현경고등학고");
	$('input[name=eduList\\[1\\]\\.eduStart]').val('2006-03-02');
	$('input[name=eduList\\[1\\]\\.eduEnd]').val('2009-02-26');
	$('input[name=eduList\\[1\\]\\.eduMajor1]').val('');
	$('input[name=eduList\\[1\\]\\.eduScore]').val('');
	$('select[name=eduList\\[1\\]\\.eduScoreStandard]').val('');
	$('select[name=eduList\\[1\\]\\.eduStatus]').val('1');
	
}

function fillWorkfield() {
	$('input[name=workfieldList\\[0\\]\\.workfield1').attr('value', '백엔드 웹개발');
	
}

function fillDesired() {
	$('select[name=desiredList\\[0\\]\\.desiredEmplForm]').val('1');
	$('input[name=desiredList\\[0\\]\\.desiredSalary]').val("4000");
	$('input[name=desiredList\\[0\\]\\.desiredCity1 ]').val('대전광역시 전체');
	$('input[name=desiredList\\[0\\]\\.desiredIndustry1 ]').val('IT · 정보통신업');
}

function fillLanguage() {
	$('select[name=langList\\[0\\]\\.langName]').val('1');
	$('input[name=langList\\[0\\]\\.langTestName]').attr('value', "TOEIC");
	$('input[name=langList\\[0\\]\\.langTestScore]').attr('value', "900");
	$('input[name=langList\\[0\\]\\.langTestDate]').attr('value', "2023-04-15");

	$('select[name=langList\\[1\\]\\.langName]').val('3');
	$('input[name=langList\\[1\\]\\.langTestName]').val("新HSK 5급");
	$('input[name=langList\\[1\\]\\.langTestScore]').val("264");
	$('input[name=langList\\[1\\]\\.langTestDate]').val("2023-02-10");
	
	$('select[name=langList\\[2\\]\\.langName]').val('1');
	$('input[name=langList\\[2\\]\\.langTestName]').val("TOEIC Speaking");
	$('input[name=langList\\[2\\]\\.langTestScore]').val("level 8, 200");
	$('input[name=langList\\[2\\]\\.langTestDate]').val("2023-04-15");
	
}

function fillCertification() {
	$('input[name=certList\\[0\\]\\.certName]').attr('value', "컴퓨터활용능력1급");
	$('input[name=certList\\[0\\]\\.certInstitution]').attr('value', "대한상공회의소");
	$('input[name=certList\\[0\\]\\.certDate]').attr('value', "2022-05-01");
	
	$('input[name=certList\\[1\\]\\.certName]').val("정보처리기사");
	$('input[name=certList\\[1\\]\\.certInstitution]').val("한국산업인력공단");
	$('input[name=certList\\[1\\]\\.certDate]').val("2021-03-21");

	$('input[name=certList\\[2\\]\\.certName]').val("한국사능력검정시험");
	$('input[name=certList\\[2\\]\\.certInstitution]').val("국사편찬위원회");
	$('input[name=certList\\[2\\]\\.certDate]').val("2009-01-31");
}

function fillAward() {
	$('input[name=awardList\\[0\\]\\.awardName]').val('전국 대학생 웹개발 경진대회');
	$('input[name=awardList\\[0\\]\\.awardInstitution]').val("산업안전부장관");
	$('input[name=awardList\\[0\\]\\.awardDate]').val("2021-05-05");
	$('input[name=awardList\\[0\\]\\.awardContent]').val("최우수상");
	
	$('input[name=awardList\\[1\\]\\.awardName]').val('모의 게임개발 대회');
	$('input[name=awardList\\[1\\]\\.awardInstitution]').val("서울특별시장");
	$('input[name=awardList\\[1\\]\\.awardDate]').val("2022-05-04");
	$('input[name=awardList\\[1\\]\\.awardContent]').val("장려상");
	
}

function fillAct() {
	$('select[name=activityList\\[0\\]\\.actCategory]').val('1');
	$('input[name=activityList\\[0\\]\\.actInstitution]').val("한국전력공사");
	$('input[name=activityList\\[0\\]\\.actStart]').val("2022-05-01");
	$('input[name=activityList\\[0\\]\\.actEnd]').val("2022-07-30");
	$('textarea[name=activityList\\[0\\]\\.actContent]').val("요금관리부서에서 전반적인 지원업무 보조");
	
	$('select[name=activityList\\[1\\]\\.actCategory]').val('4');
	$('input[name=activityList\\[1\\]\\.actInstitution]').val("서울시 동행프로젝트");
	$('input[name=activityList\\[1\\]\\.actStart]').val("2021-09-30");
	$('input[name=activityList\\[1\\]\\.actEnd]').val("2021-01-05");
	$('textarea[name=activityList\\[1\\]\\.actContent]').val("저소득층 학생들에게 주2회 영어 지도");
	
	$('select[name=activityList\\[2\\]\\.actCategory]').val('5');
	$('input[name=activityList\\[2\\]\\.actInstitution]').val("전략컨설팅학회 SSC");
	$('input[name=activityList\\[2\\]\\.actStart]').val("2019-03-09");
	$('input[name=activityList\\[2\\]\\.actEnd]').val("2020-06-30");
	$('textarea[name=activityList\\[2\\]\\.actContent]').val("부학회장으로 재임하며 매주 산업/기업 분석하여 세션 진행, 신입학회원 리크루팅 등 각종 행사 기획 ");
	
}

function fillCareer() {
	$('input[name=careerList\\[0\\]\\.careerCmpName]').val('(주)카카오');
	$('input[name=careerList\\[0\\]\\.careerCmpDprtm]').val('개발1팀');
	$('input[name=careerList\\[0\\]\\.careerJoinDate]').val('20220501');
	$('input[name=careerList\\[0\\]\\.careerResignDate]').val('20230510');
	$('input[name=careerList\\[0\\]\\.careerPosition]').val('사원');
	$('input[name=careerList\\[0\\]\\.careerWorkfield]').val('백엔드 유지 · 보수');
	$('input[name=careerList\\[0\\]\\.careerSalary]').val('4300');
	$('textarea[name=careerList\\[0\\]\\.careerDuties]').val('카카오웹툰 유지 · 보수 업무 수행');
}

function fillPrfrn() {
// 	$('input[name=prfrnList\\[0\\]\\.prfrnVeterans]').prop('checked', true);
// 	$('input[name=prfrnList\\[0\\]\\.prfrnProtection]').prop('checked', true);
	$('input[name=prfrnList\\[0\\]\\.prfrnSubsidy]').prop('checked', true);
// 	$('input[name=prfrnList\\[0\\]\\.prfrnDisability]').prop('checked', true);
	$('input[name=prfrnList\\[0\\]\\.prfrnMilitary]').prop('checked', true);
	$('select[name=prfrnList\\[0\\]\\.prfrnMilitaryType]').val("1");
	$('input[name=prfrnList\\[0\\]\\.prfrnMilitaryStart]').val("2018-02-01");
	$('input[name=prfrnList\\[0\\]\\.prfrnMilitaryEnd]').val("2019-08-05");
	$('select[name=prfrnList\\[0\\]\\.prfrnMilitaryBranch]').val("1");
	$('select[name=prfrnList\\[0\\]\\.prfrnMilitaryRank]').val("4");
	
}

function fillPortfolio() {
	$('input[name=portfolioList\\[0\\]\\.portfolioUrl]').val("https://github.com/javajungsuk");
