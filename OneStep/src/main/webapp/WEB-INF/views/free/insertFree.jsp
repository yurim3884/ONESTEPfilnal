												...
												<div class="row">
													<div class="col-md-12 mx-0">
														<form id="msform" action="/free/insert" method="post">
															<ul id="progressbar">
																<li class="active" id="account"><strong>프리랜서
																		기본 정보</strong></li>
															...
															<fieldset>
																<div class="form-card">
																	...
																	<p>
																		기본 정보를 입력해 주세요. <br> 등록하신 정보는 프로젝트 매칭 이외의 용도로는
																		활용되지 않습니다.
																	</p>
																	<br>
																	<br>
																	<div class="form-group row">
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">직군
																			/직무</label>
																	...
																	<div class="form-group row">
																		<label
																			class="col-form-label text-left col-lg-2 col-sm-12">회사/
																			팀명</label>
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<input type="text" class="form-control" value="없음"
																				name="freeCompany"> <span
																				class="form-text text-muted">소속이 있는 경우에만
																				입력해주세요</span>
																		</div>
																	</div>
																</div>
																	...
																	<div class="form-group row">
																		...
																		<div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
																			<label class="radio"> <input type="radio"
																				...
																				name="freeExper" value="N" checked="checked"> <span></span>없음
																			</label>
																		</div>
																		<label
...
<script type="text/javascript">
	function fu_click() {
		...
		$('input[name=freeSalary]')
				.attr('value', "500");
		$('input[name=freeSkill]').attr('value',
				"java");
