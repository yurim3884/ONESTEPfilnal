...
<div class="apps-ticket col-xl-12 col-lg-12 col-md-12"  style="margin: 0 auto; margin-bottom: 2%">
	...
	<table class="table mb-0">
		<thead>
			<tr>
				<th id="companyLogo" class="th1" style="text-align: center;"><img src="/upload/companyLogo.png" style='width:80%; height:150px;'></th>
				<th id="companyLogo2" class="th2" style="text-align: center;"><img src="/upload/companyLogo.png" style='width:80%; height:150px;'></th>
				<th id="companyLogo3" class="th3" style="text-align: center;"><img src="/upload/companyLogo.png" style='width:80%; height:150px;'></th>
			</tr>
		</thead>
		<tbody id="tbody">
			<tr>
			...
			<tr>
				<td id="companyCap" class="th1">회사 자본금 (만) :</td>
				<td id="companyCap2" class="th2">회사 자본금 (만) :</td>
				<td id="companyCap3" class="th3">회사 자본금 (만) :</td>
			</tr>
			<tr>
				<td id="companyTake" class="th1">회사 매출액 (만) :</td>
				<td id="companyTake2" class="th2">회사 매출액 (만):</td>
				<td id="companyTake3" class="th3">회사 매출액 (만):</td>
			</tr>
			<tr>
				<td id="companyAverage" class="th1">직원 평균 근속기간 (년) :</td>
				<td id="companyAverage2" class="th2">직원 평균 근속기간 (년) :</td>
				<td id="companyAverage3" class="th3">직원 평균 근속기간 (년) :</td>
			</tr>
			<tr>
				<td id="companyProfit" class="th1">회사 영업이익 (만) :</td>
				<td id="companyProfit2" class="th2">회사 영업이익 (만) :</td>
				<td id="companyProfit3" class="th3">회사 영업이익 (만) :</td>
			</tr>
			<tr>
				<td id="companyIncome" class="th1">회사 당기 순이익 (만) :</td>
				<td id="companyIncome2" class="th2">회사 당기 순이익 (만) :</td>
				<td id="companyIncome3" class="th3">회사 당기 순이익 (만):</td>
			</tr>
		</tbody>
	</table>
			 		...
			 		success: function(res){
						...
						var ScoreManage = reviewManage/res.reviewList.length;
				 		...
				 		if(cnt==0){
				 			...
				 			$("#companyCap").html("회사 자본금 (만) :");
				 			$("#companyTake").html("회사 매출액 (만) :");
				 			$("#companyAverage").html("직원 평균 근속기간 (년):");
				 			$("#companyProfit").html("회사 영업이익 (만) :");
				 			$("#companyIncome").html("회사 당기 순이익 (만) :");
							var logo="";
							logo="<img style=' width:80%; height:150px;' src='/upload/"+res.companyVO.companyLogo+"'"+">"
							...
							$("#companyName").html("<a href='/member/detail/"+res.companyVO.companyId+"'>"+res.companyVO.companyName+"</a>");
					 		...
					 		dataArray.push(ScoreManage);
					 		 ...
					 		 cnt++;
					 			...
					 			$("#companyCap2").html("회사 자본금 (만) :");
					 			$("#companyTake2").html("회사 매출액 (만) :");
					 			$("#companyAverage2").html("직원 평균 근속기간 (년):");
					 			$("#companyProfit2").html("회사 영업이익 (만) :");
					 			$("#companyIncome2").html("회사 당기 순이익 (만) :");
					 			var logo="";
								logo="<img style=' width:80%; height:150px;' src='/upload/"+res.companyVO.companyLogo+"'"+">"
						 		...
						 		$("#companyName2").html("<a href='/member/detail/"+res.companyVO.companyId+"'>"+res.companyVO.companyName+"</a>");
					 			...
					 			$("#companyCap3").html("회사 자본금 (만) :");
					 			$("#companyTake3").html("회사 매출액 (만) :");
					 			$("#companyAverage3").html("직원 평균 근속기간 (년):");
					 			$("#companyProfit3").html("회사 영업이익 (만) :");
					 			$("#companyIncome3").html("회사 당기 순이익 (만) :");
					 			var logo="";
								logo="<img style='width:80%; height:150px;' src='/upload/"+res.companyVO.companyLogo+"'"+">"
						 		...
						 		$("#companyCap3").html($("#companyCap3").html()+res.companyVO.companyCap/10000);
						 		$("#companyTake3").html($("#companyTake3").html()+res.companyVO.companyTake/10000);
						 		$("#companyAverage3").html($("#companyAverage3").html()+res.companyVO.companyAverage);
						 		$("#companyProfit3").html($("#companyProfit3").html()+res.companyVO.companyProfit/10000);
						 		$("#companyIncome3").html($("#companyIncome3").html()+res.companyVO.companyIncome/10000);
						 		$("#companyName3").html("<a href='/member/detail/"+res.companyVO.companyId+"'>"+res.companyVO.companyName+"</a>");
						...
						var ScoreManage = reviewManage/res.reviewList.length;
				 		...
				 		if(cnt==0){ 
							...
							logo="<img style=' width:80%; height:150px;' src='/upload/"+res.companyVO.companyLogo+"'"+">"
					 		...
					 		$("#companySmall").html($("#companySmall").html()+res.companyVO.companySmall);
					 		$("#companyEmployees").html($("#companyEmployees").html()+res.companyVO.companyEmployees);
					 		$("#companyCap").html($("#companyCap").html()+res.companyVO.companyCap.slice(0, -4));
					 		$("#companyTake").html($("#companyTake").html()+res.companyVO.companyTake.slice(0, -4));
					 		$("#companyAverage").html($("#companyAverage").html()+res.companyVO.companyAverage);
					 		$("#companyProfit").html($("#companyProfit").html()+res.companyVO.companyProfit.slice(0, -4));
					 		$("#companyIncome").html($("#companyIncome").html()+res.companyVO.companyIncome.slice(0, -4));
					 		$("#companyName").html("<a href='/member/detail/"+res.companyVO.companyId+"'>"+res.companyVO.companyName+"</a>");
					 		...
					 		dataArray.push(ScoreManage);
					 		 ...
					 		 cnt++;
								...
								logo="<img style=' width:80%; height:150px;' src='/upload/"+res.companyVO.companyLogo+"'"+">"
						 		...
						 		$("#companySmall2").html($("#companySmall2").html()+res.companyVO.companySmall);
						 		$("#companyEmployees2").html($("#companyEmployees2").html()+res.companyVO.companyEmployees);
						 		$("#companyCap2").html($("#companyCap2").html()+res.companyVO.companyCap.slice(0, -4));
						 		$("#companyTake2").html($("#companyTake2").html()+res.companyVO.companyTake.slice(0, -4));
						 		$("#companyAverage2").html($("#companyAverage2").html()+res.companyVO.companyAverage);
						 		$("#companyProfit2").html($("#companyProfit2").html()+res.companyVO.companyProfit.slice(0, -4));
						 		$("#companyIncome2").html($("#companyIncome2").html()+res.companyVO.companyIncome.slice(0, -4));
						 		$("#companyName2").html("<a href='/member/detail/"+res.companyVO.companyId+"'>"+res.companyVO.companyName+"</a>");
								...
								logo="<img style='width:80%; height:150px;' src='/upload/"+res.companyVO.companyLogo+"'"+">"
						 		...
						 		$("#companySmall3").html($("#companySmall3").html()+res.companyVO.companySmall);
						 		$("#companyEmployees3").html($("#companyEmployees3").html()+res.companyVO.companyEmployees);
						 		$("#companyCap3").html($("#companyCap3").html()+res.companyVO.companyCap.slice(0, -4));
						 		$("#companyTake3").html($("#companyTake3").html()+res.companyVO.companyTake.slice(0, -4));
						 		$("#companyAverage3").html($("#companyAverage3").html()+res.companyVO.companyAverage);
						 		$("#companyProfit3").html($("#companyProfit3").html()+res.companyVO.companyProfit.slice(0, -4));
						 		$("#companyIncome3").html($("#companyIncome3").html()+res.companyVO.companyIncome.slice(0, -4));
						 		$("#companyName3").html("<a href='/member/detail/"+res.companyVO.companyId+"'>"+res.companyVO.companyName+"</a>");
