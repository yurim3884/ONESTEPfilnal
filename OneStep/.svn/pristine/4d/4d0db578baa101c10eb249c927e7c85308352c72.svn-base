	...
	<nav id="sidebar">
		...
		<ul class="list-unstyled menu-categories" id="accordionExample">
			...
			<li class="menu"><a href="#app" data-toggle="collapse"
				aria-expanded="false" class="dropdown-toggle">
					<div>
						<span class="material-symbols-outlined"> early_on </span> <span
			...
			<li class="menu"><a href="#authentication"
				data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
					<div class="">
						<span class="material-symbols-outlined"> info </span> <span>기업정보</span>
					</div>
					<div>
			...
			<li class="menu"><a href="#cummunity" data-toggle="collapse"
				aria-expanded="false" class="dropdown-toggle">
					<div class="">
						<span class="material-symbols-outlined"> assignment </span> <span>커뮤니티</span>
					</div>
					<div>
						<i class="las la-angle-right sidemenu-right-icon"></i>
					</div>
			...
			<li class="menu"><a href="#notice" data-toggle="collapse"
				aria-expanded="false" class="dropdown-toggle">
					<div class="">
						<span class="material-symbols-outlined"> settings_suggest
						</span> <span>고객센터</span>
					</div>
					<div>
						<i class="las la-angle-right sidemenu-right-icon"></i>
